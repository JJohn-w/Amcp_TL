...
def test(test_features, test_target, input_dim, ext_hid_dim, cls_hid_dim, output_dim,extractor_path, classifier_path):
    extractor = Extractor.SharedExtractor(input_dim, ext_hid_dim, ext_hid_dim // 2).to(device)
    classifier = Classifier.TaskSpecificClassifier(ext_hid_dim // 2, cls_hid_dim, output_dim).to(device)
...
if __name__ == '__main__':
    ...
    # abp_load_path = './data/ABP_2022_10_19_only.fa'
    # afp_load_path = './data/AFP_2022_10_24_only.fa'
    # ahp_load_path = './data/AHP_2022_10_24_only.fa'
    # avp_load_path = './data/AVP_2022_10_24_only.fa'
    # acp_load_path = './data/ACP_2022_10_19_only.fa'
